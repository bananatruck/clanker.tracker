...
**That is the whole setup.** No art to download, no assets folder to populate, no environment file, no account, no build flags. The four commands above produce a 3.9 MB bundle with every screen working, the whole game drawn, and 534 tests passing.
